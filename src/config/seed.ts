...
const initDataBase =async()=>{
    ...
    if(countUser===0){
         const passwordDefault = await hashPassword("123456"); // hashPassword
        ...
        if(role){
                ...
                data:[
            {
                ...
                password:passwordDefault, // hashPassword
                fullName:"Phí Ngọc Thiện",
                accountType:"SYSTEM",
                roleId:role.id
   ...
   if(countProduct===0){
    ...
    if(countUser!==0&&countRole!==0&&countProduct){
